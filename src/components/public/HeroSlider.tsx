...
const SLIDES = [
  ...
  },
  {
    ...
    desc: 'Professional hypnotherapy and psychotherapy that go beyond symptom management. We work with anxiety, depression, trauma, and emotional wellbeing at the root level.',
  ...
  },
  {
    ...
    tag: 'Dimension 02',
    headline: 'The Brain\nDimension',
    sub: 'QEEG & Neurofeedback',
    desc: 'QEEG brain mapping sees exactly how your unique brain is wired. Neurofeedback then retrains those patterns for lasting focus, mood regulation, and mental clarity.',
